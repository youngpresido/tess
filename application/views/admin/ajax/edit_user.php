...
<div class="panel widget light-widget col-md-12">
    <div class="panel-body">
        <h3 class="mgbt-xs-20">Edit user</h3>
        <hr/>
...
<!--            <div class="form-group">
                <div class="col-md-12">
                    <label class="control-label col-md-4">Confirm Password <span class="vd_red">*</span></label>
                    <div id="confirm-password-input-wrapper" class="controls col-sm-6 col-md-8">
                        <input type="password" placeholder="Password" class="width-120 required" required  name="confirmpass" id="confirmpass">
                    </div>
                </div>
            </div>-->
            <div class="form-group">
